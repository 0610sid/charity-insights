    ...
    <div className={styles.ret}>
      <div className={styles.left}>
        ...
        <div className={styles.leftinfo}>
          ...
          <p style={{ textAlign: "center", paddingTop: "2vh" }}><a href='https://meet.google.com/?authuser=0' className={styles.link}>For more info</a></p>
        </div>
      </div>
      ...
      <div className={styles.right}>
        ...
        <div className={styles.rightbg}>
          ...
          <div className={styles.rightinput}>
            ...
            <br/>
            <select defaultValue="" >
              <option disabled hidden value="">Select Occupation</option>
          ...
          <div className={styles.location}>
            <p>Location : </p>
            {!location.latitude ?
              <p onClick={getLocation} className={styles.cord1}>Get Location</p>
              :
              <p className={styles.cord2}>{location.latitude} , {location.longitude}</p>
            }
          </div>
